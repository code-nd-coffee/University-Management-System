...
public class AddTeacher extends JFrame implements ActionListener{
    ...
    AddTeacher(){
        ...
        JLabel lemployeeID = new JLabel("Teacher ID");
        lemployeeID.setBounds(50, 250, 200, 30);
        lemployeeID.setFont(new Font("Serif",Font.BOLD, 20));
        add(lemployeeID);
        
        employeeID = new JLabel("101" + first4);
        employeeID.setBounds(200, 250, 200, 30);
        ...
        String [] courses = {"B.Tech", "BCA", "B.Sc", "BBA", "B.Com", "BA","M.Tech", "B.Ed", "MCA", "M.Sc", "MBA", "M.Com", "MA", "M.Ed", "MBBS", "PhD"};
    ...
    public void actionPerformed(ActionEvent ae){
         if(ae.getSource() == submit){
            ...
            if (b1.isSelected()){
             ...
             try{
                 String query = "Insert into teacher values('"+Name+"','"+Fname+"','"+Gender+"','"+EmployeeID+"','"+DOB+"','"+Address+"','"+Email+"','"+Phoneno+"','"+x+"','"+xii+"','"+Aadhar+"','"+Qualification+"')";
                 Con c = new Con();
